...
\begin{itemize}
    \item \textbf{ytta assimilation:} when not before another vowel, \ipa{1r}, \ipa{1m}, \ipa{1n} become a syllabic consonant \apa{\s{r}}, \apa{\s{m}}, \apa{\s{n}}. Example: \textbf{yrk} \flav{yrk} \ipa{\s{r}k}, \emph{and},  \textbf{kym} \ipa{k\s{m}}, \emph{while}. Some speaker also assimilate \ipa{1N} \textrightarrow \apa{\s{N}}, but this is fairly rare.
    ...
    \item \textbf{nasalization:} a vowel following \ipa{N} will become nasal. Example: \textbf{ngon} \flav{ngon} \ipa{N\~on}, \emph{I (ergative)}
...
\begin{tabular}[]{|*{30}{c|}}
    \hline
    a & b & d & \=d & \dh & e & è & f & g & i & \`\i & \"\i & ȉ & j & k & l \\

    \apa{a} & \apa{b} & \apa{d} & \apa{d:} & \apa{D} & \apa{e} & \apa{E:} & \apa{f} & \apa{g} & \apa{i} & \apa{i:} & \apa{1} & \apa{1:} & \apa{j} & \apa{k} & \apa{l} \\
    
    \hline
    
    \d{l} & m & \d{m} & n & \d{n} & \~n & o & ò & p & r & \d{r} & s & \v{s} & t & \=t & \textipa{W} \\
    
    \apa{\s{n}} & \apa{\textltailn} & \apa{o} & \apa{O:} & \apa{p} & \apa{r/R} & \apa{\s{r}} & \apa{s} & \apa{S} & \apa{t} & \apa{t:} & \apa{W} & \apa{\s{l}} & \apa{\s{l}:} & \apa{m} & \apa{\s{m}} \\
...
\begin{verse}\textbf{\v{s}a osàb de\~nonàk rda mjȉðlark\\\d{r}k \v{s}a rdan po\=taràt\\k\s{m} \v{s}a ðlapo\=taràt}\end{verse}
...
\textbf{[nor fa ttla] bogm karygma} \ipa{nor"fat:la bOgm kar1"gma}\\
