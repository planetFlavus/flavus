...
\flav{e}	& e	& \ipa{e} (or \apa{E})	& \apa{e} 	& etta\\
...
\begin{itemize}
    ...
    \item \ipa{1m} before another consonant becomes the syllabic consonant \apa{\s{m}}. Example: \textbf{kym} \ipa{k\s{m}}, \emph{while}.
...
\begin{tabular}{c|c|c|c}
        & \ipa{mpbtfnlt}  & \ipa{kgr} & \ipa{N}\\
        \hline\hline
        \ipa{mpbtfnlt} & \apa{i} & \apa{j1} &  \apa{jW}    \\ \hline
        \ipa{kgr} & \apa{1j} & \apa{1} & \apa{jW} \\ \hline
...
Nouns are declensed according to number and case. Three main numbers are always present: \textbf{singular}, \textbf{dual} and \textbf{plural}. 
