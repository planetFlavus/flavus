...
\end{center}
    ...
    The declension is very similar to that of a normal noun, with the exception that the absolutive affects the last, instead of the first, vowel.

    The agent infinitive of \textbf{ak} is irregular. Instead of \textbf{aken, akan, oaken, kaken}, it goes \textbf{en, an, oaken, nen}.
