...
\vspace{-30pt}
\begin{center}
    {\fontsize{100}{80}\selectfont \flav{ngon\\ongok\\keb}} 
...
As a final note, it is possible for the cluster \apa{kt} to appear exclusively in word-final position. This is not understood by Flavans as a distinct ``letter'' as it arises from a vowel elision in some genitive suffixes. Notation for \apa{kt} is explained in the section for the script.

\subsection{Pronunciation rules}

\begin{itemize}
	\item \ipa{1r} before another consonant becomes the syllabic consonant \apa{\s{r}}. Example: \textbf{yrk} \flav{yrk} \ipa{\s{r}k}, \emph{and}
    \item \ipa{1m} or \ipa{1n} before another consonant becomes the syllabic consonant \apa{\s{m}} or \apa{\s{n}}. Example: \textbf{kym} \ipa{k\s{m}}, \emph{while}.
    \item \ipa{e} and \ipa{o} when stressed open up to \apa{E} and \apa{O} respectively. Example: \textbf{borag} \flav{rgodha} \ipa{"rgO.dha}, \emph{long}, and \textbf{egord} \ipa{"Egord}, \emph{examination}
    ...
    \item word-final \ipa{D}, or \ipa{D} between two vowels becomes geminated: \apa{D:}. Example: \textbf{my agaredh} \flav{my\\agaredh} \ipa{m1aga'reD:} \emph{goodbye}
...
Another interesting system is that of the Bymarog. For them, \textbf{y} is always rounded: \apa{u} or \apa{y}, but with a strong predominance of \apa{u}. They follow the scheme:
...
In completely opposite fashion, far Demorog do tend to pronounce \textbf{y} as \apa{i} almost always, but by contrast push \textbf{o} to \apa{u} and \textbf{e} to \apa{E}.
...
\begin{vowel}
    \putcvowel{\color{red}a}{4}
    \putcvowel{\color{YellowOrange}e}{2}
    \putcvowel{\color{blue}o}{7}
    \putcvowel{\color{OliveGreen}\textipa{1}}{9}
\end{vowel}
...
\begin{vowel}
    \putcvowel{\color{red}a}{4}
    \putcvowel{\color{YellowOrange}e}{2}
    \putcvowel{\color{YellowOrange}\textipa{E}}{3}
    \putcvowel{\color{blue}\textipa{O}}{6}
    \putcvowel{\color{OliveGreen}i}{1}
    \putcvowel{\color{OliveGreen}\textipa{W}}{8}
    \putcvowel{\color{blue}o}{7}
    \putcvowel{\color{OliveGreen}\textipa{1}}{9}
\end{vowel}
\end{minipage}
...
\begin{vowel}
    ...
    \putcvowel{\color{YellowOrange}e}{2}
    \putcvowel{\color{blue}\textipa{O}}{6}
    \putcvowel[l]{\color{YellowOrange}i}{1}
    \putcvowel[r]{\color{OliveGreen}y}{1}
    \putcvowel{\color{OliveGreen}u}{8}
\end{vowel}
\end{minipage}
\hfill
\begin{minipage}{0.2\textwidth}
...
\begin{vowel}
    \putcvowel{\color{red}\textipa{A}}{5}
    \putcvowel{\color{YellowOrange}\textipa{E}}{3}
    \putcvowel{\color{OliveGreen}i}{1}
    \putcvowel{\color{blue}\textipa{u}}{8}
\end{vowel}
\end{minipage}
...
\begin{tabular}[]{*{5}{c}}
    Participle & Translation & Voice & Verb & Translation\\
    rog & writer, writing tool & Agent & akrog & write\\
    rkygo & newborn & Patient & akarkygat & be born\\
...
\begin{tabular}[]{c | c | c | c}
    dhla- & inversion & the action opposite, inverse, or undoing the original action.& \textbf{pottarat}, \emph{sew, entangle}, \textbf{dhlapottarat}, \emph{unsew, disassemble, disentangle} \\
    kyta- & negation & the original action not happening, being stopped or ignored.& \textbf{pat}, \emph{walk}, \textbf{kytapat}, \emph{not walk, stand still, wait still}\\
    \fsr & strengthening & a strengthened, more intense or faster version of the original action.& \textbf{pat}, \emph{walk}, \textbf{papat}, \emph{run}\\
\end{tabular}
...
Flavan doesn't use relative pronouns to form relative clauses in the traditional sense, for relative clauses in the in the position of subject, object, intransitive subject \emph{and} indirect object. Instead, it employs directly its extensive participle/gerund system (for bound/free relative clauses respectively).
...
Arbitrary number can be expressed in the following way. Write the number in base-16, so as a sum of powers of 16, and sort the powers from \textbf{smallest to largest}. For example, let's take $12345_{10} = 3039_{16}$, so
